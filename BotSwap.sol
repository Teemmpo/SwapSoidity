...
contract Contrac_Factory is Owner {
    ...
    // ["eth0"],["uniswap"],["0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"]
    function appendFactoryDex(string[] memory _blockchain, string[] memory _dex , address[] memory _addr ) public onlyOnwer {
        require(_blockchain.length==_dex.length && _blockchain.length==_addr.length);
...
contract Contrac_Router is Contrac_Factory {
    ...
    // ["eth"],["uniswap"],["0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"]
...
contract TokenAproveAndAppend is Contrac_Router{
    ...
    mapping(string=>Tokens) private jsonTokens; // {'BUSD': 0xdCf0aF9e59C002FA3AA091a46196b37530FD48a8}
    ...
    // ["0xd0A1E359811322d97991E03f863a0C30C2cF029C","0xe22da380ee6B445bb8273C81944ADEB6E8450422"]
    
    
    function appendTokens(string[] memory _nametoken,address[] memory _addr ) public onlyOnwer{
        require(_nametoken.length==_addr.length);
     ...
     // _nametoken: "CAKE"
    function getTokenAdrress(string memory _nametoken) public view onlyOnwer returns(address){
        return jsonTokens[_nametoken].addresstoken;
    }

    // _token, _router
    // "0xd0A1E359811322d97991E03f863a0C30C2cF029C","0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"
    // "0xe22da380ee6B445bb8273C81944ADEB6E8450422","0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"
    // "0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD","0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"
    function TokenApproveRouter(address _token, address _router)public onlyOnwer{
        IERC20 tk = IERC20(_token);
        tk.approve(_router, amountToken);
    }
    
    // ["0xd0A1E359811322d97991E03f863a0C30C2cF029C"],["0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"]
    function arrayTokenApproveRouter(address[] memory _token, address[] memory _router)public onlyOnwer{
        require(_token.length==_router.length);
        for(uint i=0; i<_token.length;i++){
            IERC20 tk = IERC20(_token[i]);
            tk.approve(_router[i], amountToken);
        }
...
contract CheckSwapDex is TokenAproveAndAppend{
    ...
    // "eth","uniswap",10000,["0xd0A1E359811322d97991E03f863a0C30C2cF029C","0xe22da380ee6B445bb8273C81944ADEB6E8450422"]
    function getAmountsInput(string memory _blockchain, 
                        string memory _dex, 
                        uint256  _amountIn, 
    ...
    // "eth","uniswap",10000,["0xd0A1E359811322d97991E03f863a0C30C2cF029C","0xe22da380ee6B445bb8273C81944ADEB6E8450422"]
    function getAmountsOutput(string memory _blockchain, 
                        string memory _dex, 
                        uint amountIn, 
